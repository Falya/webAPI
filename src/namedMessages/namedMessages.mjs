const messages = {
  ...
  PAYMENT_FAILED: { success: false, message: 'Failed payment' },
  PAYMENT_TICKETS_SUCCESS: { success: true, message: 'Tickets added to user' },
  PAYMENT_TICKETS_FAILED: { success: false, message: 'Tickets hasn`t been add to user' },
};
